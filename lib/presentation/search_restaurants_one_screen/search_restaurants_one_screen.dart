import '../search_restaurants_one_screen/widgets/listdominospizza1_item_widget.dart';
...
class SearchRestaurantsOneScreen
    extends GetWidget<SearchRestaurantsOneController> {
  @override
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller.searchRestaurantsOneModelObj.value
                            .listdominospizza1ItemList.length,
                        itemBuilder: (context, index) {
                          Listdominospizza1ItemModel model = controller
                              .searchRestaurantsOneModelObj
                              .value
                              .listdominospizza1ItemList[index];
                          return Listdominospizza1ItemWidget(
                            model,
                          );
                        },
                      ),
