...
class SlidervolumeOne2ItemWidget extends StatelessWidget {
  SlidervolumeOne2ItemWidget(this.slidervolumeOne2ItemModelObj);

  SlidervolumeOne2ItemModel slidervolumeOne2ItemModelObj;
