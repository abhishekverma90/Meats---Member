import '../search_dish_screen/widgets/search_dish_item_widget.dart';
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller.searchDishModelObj.value
                              .searchDishItemList.length,
                          itemBuilder: (context, index) {
                            SearchDishItemModel model = controller
                                .searchDishModelObj
                                .value
                                .searchDishItemList[index];
                            return SearchDishItemWidget(
                              model,
                            );
                          },
                        ),
