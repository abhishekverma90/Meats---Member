import 'controller/replace_item_controller.dart';
...
class ReplaceItemDialog extends StatelessWidget {
  ReplaceItemDialog(this.controller);

  ReplaceItemController controller;
