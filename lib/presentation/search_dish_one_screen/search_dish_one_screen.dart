import '../search_dish_one_screen/widgets/listpizza_item_widget.dart';
...
class SearchDishOneScreen extends GetWidget<SearchDishOneController> {
  @override
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller.searchDishOneModelObj.value
                              .listpizzaItemList.length,
                          itemBuilder: (context, index) {
                            ListpizzaItemModel model = controller
                                .searchDishOneModelObj
                                .value
                                .listpizzaItemList[index];
